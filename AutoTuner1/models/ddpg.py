...
class DDPG(object):
    ...
    def _sample_batch(self):
        ...
        # print "gejiake,idx:", idx
        # print "gejiake,action:", actions
    ...
    def update(self):
        ...
        #terminates 中，如果是true就。赋值0,否则就赋值1.
        ...
        # Update Critic
        # （current_value - next_value）**2 之后多个的平均值。也就是一个batch的平均值。
        ...
        # Update Actor
        self.critic.eval() #更新ACTOR时要把Critic变成评估模式。
        policy_loss = -self.critic(batch_states, self.actor(batch_states))*10  #回报越大，损失越小。
    ...
    def choose_action(self, x):
        ...
        # print "gejiake actiontype:",type(action)
        # if self.ouprocess:
