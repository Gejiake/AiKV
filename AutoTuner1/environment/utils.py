...
value_type_metrics = [
    ...
    'trx_rseg_history_len', 'file_num_open_files', 'innodb_page_size', 'metadata_mem_pool_size'
]
...
def modify_configurations(server_ip, instance_name, configuration):
    ...
    while True:
        try:
             ...
             print 's.start_mysql_bool', s.start_mysql(instance_name, params)
        except xmlrpclib.Fault:
            time.sleep(5)
        break
